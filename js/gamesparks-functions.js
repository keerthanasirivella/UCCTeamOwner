...
GameSparks.prototype.authenticationRequest = function(password, userName, onResponse, gamesparks )
{
    var request = {};
...
GameSparks.prototype.registrationRequest = function(displayName, password, userName, scriptData, onResponse, gamesparks )
{
    var request = {};
		request["displayName"] = displayName;
		request["password"] = password;
